...
namespace MusicAppUWP.View
{
    ...
    /// </summary>
    public sealed partial class MyLayout : Page
    {
        public MyLayout()
        {
            this.InitializeComponent();
            this.ContentFrame.Navigate(typeof(Profile));
...
{
    ("home", typeof(AllSongs)),
    ("upload", typeof(CreateSong)),
    ("mymusic",typeof(Profile)),
    //("profile", typeof(AllSongs)),
};
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //    Tag = "logout"
            //});
            //_pages.Add(("logout", typeof(Logout)));
